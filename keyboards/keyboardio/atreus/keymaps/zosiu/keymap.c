...
enum macros { _DK_ACT = 0, _DK_REL, _KC_COMS, _KC_CENT };
...
#define KC_CMTB RGUI(KC_TAB)      // command + tab
#define KC_OPTB RALT(KC_TAB)      // optoin + tab
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUN] = LAYOUT( \
    XXXXXXX, KC_DEL,  KC_C_LF, KC_C_RT, XXXXXXX,                   KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX, \
    KC_GRV,  KC_END,  KC_PGUP, KC_PGDN, KC_HOME,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, \
    KC_OPTB, KC_CMTB, KC_CSTB, KC_C_TB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F14,  KC_COMM, KC_F15,  KC_CIRC, \
